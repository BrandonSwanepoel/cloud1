...
> The WordPress site will be hosted at http://130.211.24.244/. The site will only be up during evalutaion.
...
## Diagram
![GCP Infrastructure Diagram](https://github.com/BrandonSwanepoel/cloud1/blob/main/cloud1-diagram.png)
